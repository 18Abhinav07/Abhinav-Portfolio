      ...
      <div className="grid md:grid-cols-12 gap-column-gap items-end">
        <div className="md:col-span-6 relative">
          <motion.div
            ...
            className="aspect-[3/4] w-full bg-surface-container-low brutalist-rule-t brutalist-rule-b brutalist-rule-l brutalist-rule-r relative overflow-hidden will-change-transform"
          >
            ...
            <motion.div
              style={{ y: labelY }}
              className="absolute top-stack-md left-stack-md font-mono text-label-mono uppercase tracking-[0.18em] text-primary z-20"
            >
              Subject · 001
            </motion.div>
            <motion.div
              style={{ y: labelY }}
              className="absolute bottom-stack-md right-stack-md font-mono text-label-mono uppercase tracking-[0.18em] text-on-surface-variant z-20"
            >
              28.6139° N
            </motion.div>
          </motion.div>
        ...
        <StaggerGroup className="md:col-start-8 md:col-span-5 flex flex-col gap-stack-lg">
          <StaggerItem>
